...
enum
{
    c_Low = 0,        //!< Value representing digital LOW
    c_High = 1        //!< Value representing digital HIGH
};
 ...
 * \arg \c pinNbr a number between 0 and 7 identifying the pin number on that port that corresponds to the GPIO pin.
 *
 * \hideinitializer
 */
 ...
 *
 * \arg \c pinName a GPIO pin name macro generated by GpioPin()
 *
 * \hideinitializer
 */
...
/*!
 * \brief Read the value (voltage level) of the GPIO pin (i.e., return the value of correspoinding the PINn bit).
 *
 * \arg \c pinName a GPIO pin name macro generated by `GpioPin()`.
 *
 * \returns 0 (`c_Low`, Low-Voltage-Level) or 1 (`c_High`, High-Voltage-level).
 *
 * \hideinitializer
 */
...
/*!
 * \brief Write a voltage-level the GPIO pin (i.e., set or clear the corresponding  PORTn bit).
 *
 * \arg \c pinName a GPIO pin name macro generated by `GpioPin()`.
 * \arg \c val the voltage-level to be written: 0 means Low-level; any other value means High-level.
 *         Constants `c_Low` or `c_High` can be used.
 *
 * \hideinitializer
 */
...
/*!
 * \brief Write a high-voltage-level to the GPIO pin (i.e., set the corresponding  PORTn bit).
 *
 * \arg \c pinName a GPIO pin name macro generated by `GpioPin()`.
 *
 * \hideinitializer
...
/*!
 * \brief Write a low-voltage-level the GPIO pin (i.e., clear the corresponding the PORTn bit).
 *
 * \arg \c pinName a GPIO pin name macro generated by `GpioPin()`.
 *
 * \hideinitializer
...
public:
     ...
     *
     * \returns `c_Low` (0) for a low-voltage-Level, `c_High` (1) for a high-voltage-level
     */
